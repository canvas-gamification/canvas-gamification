...
from api.permissions import StudentsMustBeRegisteredPermission, CourseEditPermission
...
class CourseViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    permission_classes = [StudentsMustBeRegisteredPermission, CourseEditPermission, ]
