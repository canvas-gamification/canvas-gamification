...
class LoginActionTest(BaseTestCase):
    def test(self):
        ...
        self.assertTrue(Action.objects.filter(actor=self.user, verb=ActionVerb.LOGGED_IN).exists())


class LogoutActionTest(BaseTestCase):
    def test(self):
        create_logout_action(self.user)
        self.assertTrue(Action.objects.filter(actor=self.user, verb=ActionVerb.LOGGED_OUT).exists())
...
class UpdateUserProfileActionTest(BaseTestCase):
    def test(self):
        ...
        self.assertTrue(Action.objects.filter(actor=self.user, verb=ActionVerb.UPDATED).exists())
...
class CreateEventActionTest(BaseTestCase):
    def test(self):
        ...
        self.assertTrue(Action.objects.filter(actor=self.user, verb=ActionVerb.CREATED).exists())
...
class ImportEventActionTest(BaseTestCase):
    def test(self):
        ...
        self.assertTrue(Action.objects.filter(actor=self.user, verb=ActionVerb.DUPLICATED).exists())
