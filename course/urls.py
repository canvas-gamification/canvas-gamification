...
from course.views.views import (
    problem_set_view,
    question_view,
    java_question_create_view,
    submission_detail_view,
    token_values_table_view,
    question_edit_view,
    parsons_question_create_view,
    multiple_choice_question_create_view,
    question_delete_view,
)

urlpatterns = [
    path(
        "new-problem/multiple-choice",
        multiple_choice_question_create_view,
        name="new_problem_multiple_choice",
    ),
    path("new-problem/java", java_question_create_view, name="new_problem_java"),
    path(
        "new-problem/parsons",
        parsons_question_create_view,
        name="new_problem_parsons",
    ),
    path(
        "submission/<int:pk>",
        submission_detail_view,
