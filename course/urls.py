...
from course.views.views import problem_set_view, question_view, java_question_create_view, submission_detail_view, \
    token_values_table_view, question_edit_view, parsons_question_create_view, multiple_choice_question_create_view, \
