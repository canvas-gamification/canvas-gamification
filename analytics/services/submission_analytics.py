...
def create_submission_analytics(submission):
    ...
    if isinstance(submission, JavaSubmission):
        ...
        uqj, submission, question, event, user_id, first_name, last_name, ans_file, num_attempts,
        is_correct, time_spent, lines, blank_lines, comment_lines, import_lines, cyclomatic_complexity, method,
        operator, operand, unique_operator, unique_operand, vocab, size, vol, difficulty, effort, error,
        test_time
        submission_analytics_obj = JavaSubmissionAnalytics.create(submission.uqj, submission, submission.question,
                                                                  submission.question.event, submission.user,
                                                                  user_obj.first_name, user_obj.last_name, ans,
                                                                  num_attempts, is_correct, time_spent,
                                                                  sub_analytics_dict.lines,
                                                                  sub_analytics_dict.blank_lines,
                                                                  sub_analytics_dict.comment_lines,
                                                                  sub_analytics_dict.imported_lines,
                                                                  sub_analytics_dict.cc, sub_analytics_dict.method,
                                                                  sub_analytics_dict.operator,
                                                                  sub_analytics_dict.operand,
                                                                  sub_analytics_dict.unique_operator,
                                                                  sub_analytics_dict.unique_operand,
                                                                  sub_analytics_dict.vocab,
                                                                  sub_analytics_dict.size,
                                                                  sub_analytics_dict.vol,
                                                                  sub_analytics_dict.difficulty,
                                                                  sub_analytics_dict.effort,
                                                                  sub_analytics_dict.error,
                                                                  sub_analytics_dict.test_time)
