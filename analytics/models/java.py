...
class JavaSubmissionAnalytics(SubmissionAnalytics):
    ...
    def create_submission_analytics(submission):
        try:
            sub_analytics = JavaSubmissionAnalytics.objects.get(submission=submission.pk)
            ...
            JavaSubmissionAnalytics.objects.create(uqj=submission.uqj.pk, submission=submission.pk,
