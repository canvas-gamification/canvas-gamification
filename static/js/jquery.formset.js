    ...
    $.fn.formset = function (opts) {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            insertDeleteLink = function (row) {
                ...
                var delButtonHTML = '<a class="btn btn-danger m-auto ' + options.deleteCssClass + '" href="javascript:void(0)">' + options.deleteText + '</a>';
        ...
        if ($$.length) {
            ...
            var addButtonHTML = '<a class="btn btn-primary ' + options.addCssClass + '" href="javascript:void(0)">' + options.addText + '</a>';
